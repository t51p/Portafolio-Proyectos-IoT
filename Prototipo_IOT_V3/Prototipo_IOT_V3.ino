...
#define ADC_VREF_mV    2800.0 // in millivolt   
...
/*Serial monitor setup*/
 Serial.begin(9600);
  Serial.println(" Regaderazo ONLINE ");
...
/*  LM35  */
  ...
  tempC = milliVolt / 12;                                /*convert the voltage to the temperature in °C*/
...
// Se ponen los campos definidos en el canal ThingSpeak con las variables de temperatura y humedad
 ...
 ThingSpeak.setField (1,flowRate); //En el campo 1 se le asigna la temperatura (t1)
 ThingSpeak.setField (2,tempC); //En el campo 2 se le asigna la humedad (h1)
 ThingSpeak.setField (3,valvestatus); //En el campo 2 se le asigna la humedad (h1)
